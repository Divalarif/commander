...
7. **Travel** back to the base station name is **station** and **dock**,check market price **view_market** and **get_listings**, **craft and rifine** at **station or base** craft and refine important for us focus on that, if you need resouurces you can check **view_storage** and **withdraw** ore don't sell ores
